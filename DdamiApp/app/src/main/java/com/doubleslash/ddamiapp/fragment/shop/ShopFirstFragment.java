                ...
                .subscribe(
                        it -> {
                            ...
                            for(int i = 0; i<it.getProducts().size(); i++){
                                ...
                                mData.add(new ShopWorkItem(product.getPieces().get(0).getFileUrl(), product.getTitle(), product.getLocationName(), product.getPrice(), product.getViews(), product.getLikeCount()));
                            }

                            mAdapter = new ShopWorkAdapter(mData);
